...
\subsection{Algorytmy detekcji wysokości tonu}
\begin{spacing}{1.5} % Zaczynamy interlinię 1.5
...
\subsection{Testowanie prototypu}
\begin{spacing}{1.5} % Zaczynamy interlinię 1.5
...
\subsection{Integracja wtyczki z oprogramowaniem DAW} %Digital Audio Workstation
\begin{spacing}{1.5} % Zaczynamy interlinię 1.5
