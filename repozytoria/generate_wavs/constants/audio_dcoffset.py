...
Constants
---------
AUDIO_DC_OFFSET : dict[str, tuple[float, ...]]
    A dictionary where keys represent the offset level names ("none", "low",
    "medium", "high") and values are tuples containing the corresponding
    DC offset values in float format.
"""
